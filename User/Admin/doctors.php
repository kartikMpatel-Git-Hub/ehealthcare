...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where doc_email='$keyword' or doc_name='$keyword' or doc_name like '$keyword%' or doc_name like '%$keyword' or doc_name like '%$keyword%'";
                    }else{
                        $sqlmain= "select * from doctor order by doc_id";
    ...
    if($_GET){  
        ...
        elseif($action=='view')
        {
            ...
            ';
                ...
                $errorlist= array(
                    ...
                    '3'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">This Phone Number Is Already Exist</label>',
                    '4'=>'',
                    '0'=>"",
                    '5'=>"Enter All Filed First !",
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="charge" class="input-text" placeholder="Charge" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <input type="radio" name="gender" value="Female" style="display: inline-block; width: auto; margin-bottom : 30px;"/>Female
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="spec" id="" class="box" >';
                                        ...
                                        echo "<option values=> -Select- </option><br> ";
                                        $list11 = $database->query("select  * from  specialist order by spec_type asc;");
        ...
        ';
            ...
            $errorlist= array(
                ...
                '4'=>"",
                '0'=>'',
                '5'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Phone No Already Exist</label>',
            );
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <br>
                                                <input type="radio" name="gender" value="Male"   '; if($gen == "Male"){ echo 'checked';} echo '>Male
                                                <input type="radio" name="gender" value="Female" '; if($gen == "Female"){ echo 'checked';} echo '>Female
                                            <br>
                                            <br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="address" class="input-text" placeholder="Doctor Address" value="'.$address.'" required><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="phoneno" class="input-text" placeholder="Doctor Name" value="'.$pno.'" required><br>
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="name" class="form-label">Charge: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="charge" class="input-text" placeholder="Doctor Name" value="'.$charge.'" required><br>
                                        </td>
                                    </tr>
